...
export interface OpGasPriceOracleInterface extends Interface {
    ...
    encodeFunctionData(functionFragment: "getL1FeeUpperBound", values: [BigNumberish]): string;
...
export interface OpGasPriceOracle extends BaseContract {
    ...
    getFunction(nameOrSignature: "baseFeeScalar"): TypedContractMethod<[], [bigint], "view">;
    getFunction(nameOrSignature: "blobBaseFee"): TypedContractMethod<[], [bigint], "view">;
    getFunction(nameOrSignature: "blobBaseFeeScalar"): TypedContractMethod<[], [bigint], "view">;
    getFunction(nameOrSignature: "decimals"): TypedContractMethod<[], [bigint], "view">;
    ...
    getFunction(nameOrSignature: "getL1FeeUpperBound"): TypedContractMethod<[_unsignedTxSize: BigNumberish], [bigint], "view">;
    getFunction(nameOrSignature: "getL1GasUsed"): TypedContractMethod<[_data: BytesLike], [bigint], "view">;
    getFunction(nameOrSignature: "isEcotone"): TypedContractMethod<[], [boolean], "view">;
    getFunction(nameOrSignature: "isFjord"): TypedContractMethod<[], [boolean], "view">;
    ...
    getFunction(nameOrSignature: "setEcotone"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "setFjord"): TypedContractMethod<[], [void], "nonpayable">;
