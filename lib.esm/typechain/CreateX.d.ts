...
export interface CreateXInterface extends Interface {
    ...
    encodeFunctionData(functionFragment: "computeCreate3Address(bytes32,address)", values: [BytesLike, AddressLike]): string;
    encodeFunctionData(functionFragment: "computeCreate3Address(bytes32)", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "computeCreateAddress(uint256)", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "computeCreateAddress(address,uint256)", values: [AddressLike, BigNumberish]): string;
    encodeFunctionData(functionFragment: "deployCreate", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "deployCreate2(bytes32,bytes)", values: [BytesLike, BytesLike]): string;
    encodeFunctionData(functionFragment: "deployCreate2(bytes)", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "deployCreate2AndInit(bytes32,bytes,bytes,(uint256,uint256),address)", values: [BytesLike, BytesLike, BytesLike, CreateX.ValuesStruct, AddressLike]): string;
    encodeFunctionData(functionFragment: "deployCreate2AndInit(bytes,bytes,(uint256,uint256))", values: [BytesLike, BytesLike, CreateX.ValuesStruct]): string;
    encodeFunctionData(functionFragment: "deployCreate2AndInit(bytes,bytes,(uint256,uint256),address)", values: [BytesLike, BytesLike, CreateX.ValuesStruct, AddressLike]): string;
    encodeFunctionData(functionFragment: "deployCreate2AndInit(bytes32,bytes,bytes,(uint256,uint256))", values: [BytesLike, BytesLike, BytesLike, CreateX.ValuesStruct]): string;
    encodeFunctionData(functionFragment: "deployCreate2Clone(bytes32,address,bytes)", values: [BytesLike, AddressLike, BytesLike]): string;
    encodeFunctionData(functionFragment: "deployCreate2Clone(address,bytes)", values: [AddressLike, BytesLike]): string;
    encodeFunctionData(functionFragment: "deployCreate3(bytes)", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "deployCreate3(bytes32,bytes)", values: [BytesLike, BytesLike]): string;
    encodeFunctionData(functionFragment: "deployCreate3AndInit(bytes32,bytes,bytes,(uint256,uint256))", values: [BytesLike, BytesLike, BytesLike, CreateX.ValuesStruct]): string;
    encodeFunctionData(functionFragment: "deployCreate3AndInit(bytes,bytes,(uint256,uint256))", values: [BytesLike, BytesLike, CreateX.ValuesStruct]): string;
    encodeFunctionData(functionFragment: "deployCreate3AndInit(bytes32,bytes,bytes,(uint256,uint256),address)", values: [BytesLike, BytesLike, BytesLike, CreateX.ValuesStruct, AddressLike]): string;
    encodeFunctionData(functionFragment: "deployCreate3AndInit(bytes,bytes,(uint256,uint256),address)", values: [BytesLike, BytesLike, CreateX.ValuesStruct, AddressLike]): string;
    encodeFunctionData(functionFragment: "deployCreateAndInit(bytes,bytes,(uint256,uint256))", values: [BytesLike, BytesLike, CreateX.ValuesStruct]): string;
    encodeFunctionData(functionFragment: "deployCreateAndInit(bytes,bytes,(uint256,uint256),address)", values: [BytesLike, BytesLike, CreateX.ValuesStruct, AddressLike]): string;
    encodeFunctionData(functionFragment: "deployCreateClone", values: [AddressLike, BytesLike]): string;
...
export declare namespace ContractCreation_address_bytes32_Event {
    type InputTuple = [newContract: AddressLike, salt: BytesLike];
    type OutputTuple = [newContract: string, salt: string];
...
export declare namespace ContractCreation_address_Event {
...
export declare namespace Create3ProxyContractCreationEvent {
    type InputTuple = [newContract: AddressLike, salt: BytesLike];
    type OutputTuple = [newContract: string, salt: string];
    interface OutputObject {
        newContract: string;
...
export interface CreateX extends BaseContract {
    ...
    getFunction(nameOrSignature: "computeCreate3Address(bytes32)"): TypedContractMethod<[salt: BytesLike], [string], "view">;
    getFunction(nameOrSignature: "computeCreateAddress(uint256)"): TypedContractMethod<[nonce: BigNumberish], [string], "view">;
    ...
    getFunction(nameOrSignature: "deployCreate"): TypedContractMethod<[initCode: BytesLike], [string], "payable">;
    ...
    getFunction(nameOrSignature: "deployCreate2(bytes)"): TypedContractMethod<[initCode: BytesLike], [string], "payable">;
    ...
    getFunction(nameOrSignature: "deployCreate3(bytes)"): TypedContractMethod<[initCode: BytesLike], [string], "payable">;
