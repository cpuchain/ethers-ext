...
export declare namespace OraclePrices {
    ...
    type OraclePriceStructOutput = [rate: bigint, weight: bigint] & {
        rate: bigint;
        weight: bigint;
    };
    type DataStruct = {
...
export interface OffchainOracleInterface extends Interface {
    ...
    encodeFunctionData(functionFragment: "getRatesAndWeightsToEthWithCustomConnectors", values: [AddressLike, boolean, AddressLike[], BigNumberish]): string;
    encodeFunctionData(functionFragment: "getRatesAndWeightsWithCustomConnectors", values: [AddressLike, AddressLike, boolean, AddressLike[], BigNumberish]): string;
